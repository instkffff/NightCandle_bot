...
var Factions = function (_CallableInstance) {
  (0, _inherits3.default)(Factions, _CallableInstance);
   ...
   * @constructor
   */
  function Factions(agent) {
    (0, _classCallCheck3.default)(this, Factions);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Factions.__proto__ || (0, _getPrototypeOf2.default)(Factions)).call(this, function () {
      return _this.all();
    }));
  ...
  (0, _createClass3.default)(Factions, [{
    key: 'all',
